...
Note that all of these notebooks operate on the outputs generated by the software scripts, which are described below.
...
### Root scripts ([`software_scripts/`](software_scripts/))
...
### Pathogen abundance ([`software_scripts/pathogen_abundance/`](software_scripts/pathogen_abundance/))
...
### Resistance analysis ([`software_scripts/resistance_analysis/`](software_scripts/resistance_analysis/))
...
### Pathogen assembly workflows ([`software_scripts/pathogen_assembly/`](software_scripts/pathogen_assembly/))
